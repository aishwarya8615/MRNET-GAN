...
csvs = ["train-acl.csv", "train-abnormal.csv", "train-meniscus.csv", "valid-acl.csv", "valid-abnormal.csv",
        "valid-meniscus.csv"]
for c in csvs:
    with open('C:/Fall19/AI/Project/MRNet-v1.0/' + c, newline='') as csvfile:
...
#@@ -165,9 +163,6 @@ def getTheDataLabelPerView_(obj,save_in,idx):
# load y_train
valid_ = []
...
BUFFER_SIZE = 60000
BATCH_SIZE = 256 #Originally batch size was 256
