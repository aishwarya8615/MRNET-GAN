...
train_axial_lbl = train_coronal_lbl.reshape(38778, 1)
print("label shape ", train_coronal_lbl.shape)

x_train, x_test, y_train, y_test = train_test_split(train_coronal, train_coronal_lbl, test_size=0.2, random_state=42)
...
# Save checkpoint
filepath_checkpoint = "/home/vvarier/ai_project/output_file/resnet50_coronal_checkpoint.hdf5"
...
print ("Test Accuracy Coronal = " + str(preds[1]))
# parallel_model.summary()
parallel_model.save('/home/vvarier/ai_project/output_file/weights_file/ResNet50_coronal.h5')
print ("The model has been saved successfully!")
print ("The test accuracy was of coronal ", preds[1])
