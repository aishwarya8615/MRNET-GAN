...
train_axial_lbl = train_sagittal_lbl.reshape(38778, 1)
print("label shape ", train_sagittal_lbl.shape)

x_train, x_test, y_train, y_test = train_test_split(train_sagittal, train_sagittal_lbl, test_size=0.2, random_state=42)
...
# Save checkpoint
filepath_checkpoint = "/home/vvarier/ai_project/output_file/resnet50_sagittal_checkpoint.hdf5"
...
print ("Test Accuracy sagittal = " + str(preds[1]))
# parallel_model.summary()
parallel_model.save('/home/vvarier/ai_project/output_file/weights_file/ResNet50_sagittal.h5')
print ("The model has been saved successfully!")
print ("The test accuracy was of sagittal ", preds[1])
